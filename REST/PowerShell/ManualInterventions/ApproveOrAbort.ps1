...
$InterruptionID = "" #You can get this ID from the deployment document like this -> /api/interruptions?regarding=[Deployment ID]

$header = @{ "X-Octopus-ApiKey" = $OctopusAPIKey }

$body = @{Instructions= ""
            Notes = "Message" #message 
            Result="Proceed" #Set this property to "Abort" to abourt the deployment           
        } | ConvertTo-Json
