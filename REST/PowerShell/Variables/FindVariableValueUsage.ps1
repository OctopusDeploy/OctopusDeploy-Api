...
# Specify the Spaces to search
$spaceNames = @("Default", "YOUROTHERSPACES")
...
{
    # Optional: set a path to export to csv, one file per space
    $csvExportPath = "$scriptPath/$spaceName-$variableValueToFind.csv"
